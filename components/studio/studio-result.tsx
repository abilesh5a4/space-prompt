...
export function StudioResult({
  ...
  return (
    <div className="space-y-3 max-w-2xl">
      <p className="text-xs font-medium text-[#A1A1AA]">Here&apos;s a prompt tailored to your request:</p>
      
      <div className="rounded-2xl border border-[#29292B] bg-[#181819] p-4 text-sm text-[#F4F4F5] leading-relaxed whitespace-pre-wrap font-sans shadow-xs">
        {promptText}
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3 text-xs">
        <button
          type="button"
          onClick={handleCopy}
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-[#29292B] bg-[#181819] hover:bg-[#29292B] text-[#F4F4F5] transition-colors"
        >
        ...
        <button
          ...
          disabled={isSaving}
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-[#29292B] bg-[#181819] hover:bg-[#29292B] text-[#F4F4F5] transition-colors disabled:opacity-50"
        >
